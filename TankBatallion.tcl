...
#
# Generated by Vivado on Sat May 28 13:39:24 -0500 2022
...
#
#    "C:/Git/zybo-tankbatallion/TankBatallion/TankBatallion.srcs/utils_1/imports/synth_1/TankBatallion_VGA_Top.dcp"
#
...
#    "C:/Git/zybo-tankbatallion/sources/utils_1/imports/synth_1/TankBatallion_top.dcp"
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/TankBatallion/TankBatallion.srcs/utils_1/imports/synth_1/TankBatallion_VGA_Top.dcp"]"\
  ]
  foreach ifile $files {
 ...
 "[file normalize "$origin_dir/sources/utils_1/imports/synth_1/TankBatallion_top.dcp"]"\
...
set file "$origin_dir/sources/utils_1/imports/synth_1/TankBatallion_top.dcp"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "synth_1/TankBatallion_VGA_Top.dcp"
...
set_property -name "incremental_checkpoint" -value "$proj_dir/TankBatallion.srcs/utils_1/imports/synth_1/TankBatallion_VGA_Top.dcp" -objects $obj
