...
##LEDs
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports o_led_drive]
...
set_property PACKAGE_PIN E17 [get_ports clock_enable]
set_property IOSTANDARD LVCMOS33 [get_ports clock_enable]



set_property PACKAGE_PIN R18 [get_ports i_reset]
...
set_property PACKAGE_PIN P19 [get_ports {VGAports[h_sync]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[h_sync]}]
set_property PACKAGE_PIN R19 [get_ports {VGAports[v_sync]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[v_sync]}]
set_property PACKAGE_PIN M19 [get_ports {VGAports[red][0]}]
set_property PACKAGE_PIN L20 [get_ports {VGAports[red][1]}]
set_property PACKAGE_PIN J20 [get_ports {VGAports[red][2]}]
set_property PACKAGE_PIN G20 [get_ports {VGAports[red][3]}]
set_property PACKAGE_PIN F19 [get_ports {VGAports[red][4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[red][4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[red][3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[red][2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[red][1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[red][0]}]
set_property PACKAGE_PIN H18 [get_ports {VGAports[green][0]}]
set_property PACKAGE_PIN N20 [get_ports {VGAports[green][1]}]
set_property PACKAGE_PIN L19 [get_ports {VGAports[green][2]}]
set_property PACKAGE_PIN J19 [get_ports {VGAports[green][3]}]
set_property PACKAGE_PIN H20 [get_ports {VGAports[green][4]}]
set_property PACKAGE_PIN F20 [get_ports {VGAports[green][5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[green][5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[green][4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[green][3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[green][2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[green][1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[green][0]}]
set_property PACKAGE_PIN P20 [get_ports {VGAports[blue][0]}]
set_property PACKAGE_PIN M20 [get_ports {VGAports[blue][1]}]
set_property PACKAGE_PIN K19 [get_ports {VGAports[blue][2]}]
set_property PACKAGE_PIN J18 [get_ports {VGAports[blue][3]}]
set_property PACKAGE_PIN G19 [get_ports {VGAports[blue][4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[blue][4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[blue][3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[blue][2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[blue][1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {VGAports[blue][0]}]
